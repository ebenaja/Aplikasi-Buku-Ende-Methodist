...
import 'nrm_biru_detail_page.dart';

class NrmBiruPage extends StatefulWidget {
  const NrmBiruPage({super.key});

  @override
  State<NrmBiruPage> createState() => _NrmBiruPageState();
}

class _NrmBiruPageState extends State<NrmBiruPage> {
  // --- PALET WARNA (BIRU) ---
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [primaryBiru, primaryBiru.withOpacity(0.8)],
              ),
              ...
              boxShadow: [
                BoxShadow(
                  color: primaryBiru.withOpacity(0.4),
                  blurRadius: 15,
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.search, color: primaryBiru),
